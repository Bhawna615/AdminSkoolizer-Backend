...
class Fee extends CI_Controller
{
    ...
    {
		$period = urldecode($this->input->post('period'));
    	...
    	public function statistics()
	{
		...
		$data['periods'] = $this->FeeModel->getPeriods();
		$this->load->view('fee/statistics/select', $data);
	}
	...
	public function displayStatistics()
	{
		...
		$data['fees'] = $this->FeeModel->getDataByPeriod($period);
		$this->load->view('fee/statistics/view', $data);
	}

	public function viewTotalPaymentsByPeriod($period)
	{
		$data['payments'] = $this->FeeModel->getTotalPaymentsByPeriod(urldecode($period));
		$this->load->view('fee/statistics/period/view', $data);
	}

	public function viewPaidPaymentsByPeriod($period)
	{
		$data['payments'] = $this->FeeModel->getPaidPaymentsByPeriod(urldecode($period));
		$this->load->view('fee/statistics/period/view', $data);
	}

	public function viewPendingPaymentsByPeriod($period)
	{
		$data['payments'] = $this->FeeModel->getPendingPaymentsByPeriod(urldecode($period));
		$this->load->view('fee/statistics/period/view', $data);
	}

	public function viewPaidPaymentsByDate()
	{
		...
		public function editPaidFee()
    {
        $feeId = $this->input->post('id');
        $data['payment'] = $this->FeeModel->getPayment($feeId);
        $this->load->view('fee/paid/edit', $data);
    }
