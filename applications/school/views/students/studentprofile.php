...
<div class="col-md-12 innerview profile-holder">
	<?php foreach ($student as $row) { ?>
		...
		<div class="col-md-4">
			...
			<p class="profile-heading">Guardian's Name</p>
			...
			<p class="profile-info"><?php echo $row->House; ?></span></p>
				<p class="profile-heading">Tuition Fee</p>
			<p class="profile-info"><?php echo $row->tuition_fee; ?></span></p>
				<p class="profile-heading">Annual Fee</p>
			<p class="profile-info"><?php echo $row->annual_fee; ?></span></p>
				<p class="profile-heading">Admission Fee</p>
			<p class="profile-info"><?php echo $row->admission_fee; ?></span></p>
				<p class="profile-heading">Transport Fee</p>
			<p class="profile-info"><?php echo $row->transport_fee; ?></span></p>
