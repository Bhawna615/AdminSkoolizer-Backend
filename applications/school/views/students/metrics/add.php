...
<div class="col-md-12 innerview">
    ...
    <?php if (isset($student)) { ?>
        ...
        <table class="table table-responsive table-bordered dataTableFull" id="table1">
            ...
            <?php if (isset($metrics)) { ?>
                <?php foreach ($metrics as $metric) { ?>
                    <tr>
                        ...
                        <td>
                            <?php
                            // Check if there's a studentMetric entry for this metric
                            $found = false;
                            if (isset($studentMetric)) {
                            ...
                            // If no entry is found, show an empty input field
                            if (!$found) { ?>
