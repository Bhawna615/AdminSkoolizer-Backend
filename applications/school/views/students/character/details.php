...
<div class="col-md-12 innerview">
	...
	<div class="col-md-12 form-box">
		...
		<div class="col-md-12" style="padding-top: 20px;">
			<form action="<?php echo site_url('student/generateCharacterCertificate'); ?>" method="POST" enctype="multipart/form-data">
			    <input type="hidden" name="id" value="<?php echo $id ?>" />
				<div class="col-md-4">
					<p class="details">Admission Date</p>
					<input
							type="text"
							name="admission_date"
							class="form-input"
					...
					<p class="details">Graduation Date</p>
					<input
							type="text"
  ...
  <script>
      ...
      <script>
        $(document).ready(function() {
            ...
            $(function() {
                $( "#graudation_date" ).datepicker({ dateFormat: 'dd-mm-yy' });
            });
        })
    </script>
