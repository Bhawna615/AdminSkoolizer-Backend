	...
	<?php foreach ($info as $row) { ?>
		<div class="col-md-12" style=" border: 1px solid; border-radius: 5px; border-color: #EBEBEC; padding: 0px;">
			...
			<div class="col-md-12" style="padding: 20px;">
				<p style="font-size: 30px; text-transform: uppercase; font-family: Nunito-Semibold;" align="center">
					Attendance Details</p>
				<p style="font-family: RedhatR; font-size: 25px;"><span
						style="font-size: 48px;"><?php echo $attendance[1]; ?></span> out of <span
						style="font-size: 48px;"><?php echo $attendance[0]; ?></span> days</p>
				...
				<?php foreach ($attendance[2] as $key) { ?>
					<p style="font-family: RedhatR; font-size: 20px;">
						<?php $date = date('d F, Y', strtotime($key->Date));
						echo $date; ?></p>
				<?php } ?>
			</div>
		</div>
