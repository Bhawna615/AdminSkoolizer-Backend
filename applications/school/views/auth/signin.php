...
<div class="col-md-12" align="center" style="padding-top: 50px; ">
	...
	<div class="col-md-12" style="" align="center">
		...
		<div class="col-md-4" style="border: 1px solid white; border-radius: 5px; margin-top: 60px;">
			<p style="background: #fff; color: #FFAE10; border-radius: 5px; width: 50%; font-family: Nunito-Semibold; text-transform: uppercase; font-size: 18px; padding: 5px 25px 5px 25px; position: relative;bottom: 20px;">
				Admin Login</p>
			<form method="POST" action="<?php echo site_url('auth/signin'); ?>">
				...
				<div class="col-md-12">
					<button style="font-family: Nunito_Regular; border: 1px solid white; border-radius: 5px; color: white; padding: 5px 25px 5px 25px; background: #FFAE10; font-size: 20px; margin-top: 40px; position: relative; top: 20px;">
						Log In
					</button>
				</div>
			</form>
