	...
	<div class="col-md-12">
		<table class="table table-responsive table-bordered dataTableFull" id="table">
			...
			<tr>
				...
				<th>Name</th>
				<th>Class</th>
				<th><input type="checkbox" id="selectall-admission-fee" checked/> Admission Fee</th>
				<th><input type="checkbox" id="selectall-annual-charges" checked/> Annual Charges</th>
				<!--<th><input type="checkbox" id="selectall-sibling-discount" checked/> Sibling Discount</th>-->
				<th><input type="checkbox" id="selectall-tuition-fee" checked/> Tuition Fee</th>
				<th>Total Fee</th>
			</tr>
			</thead>
				...
				<?php foreach ($students as $row) { ?>
					<tr>
						...
						<td>
						    <input
								type="checkbox"
								name="admission-fee[<?php echo $row->id ?>]"
								class="id-<?php echo $row->id?> admission-fee admission-fee-checkbox-student-id-<?php echo $row->id?>"
								value="<?php echo $row->admission_fee ?>" checked
							/>
							<input 
							     type="text"
							     class="admission-fee-textbox-id-<?php echo $row->id ?>"
							     value="<?php echo $row->admission_fee ?>" 
							     disabled
							 />
							 <input
    							 type="text"
    							 id="discount-admission-fee-id-<?php echo $row->id ?>"
						...
						<td>
						    <input
								type="checkbox"
								name="annual-fee[<?php echo $row->id ?>]"
								class="id-<?php echo $row->id?> annual-fee annual-fee-checkbox-student-id-<?php echo $row->id?>"
								value="<?php echo $row->annual_fee ?>" checked
							/>
							<input 
							     type="text"
							     value="<?php echo $row->annual_fee ?>"
							     class="annual-fee-textbox-id-<?php echo $row->id ?>"/>
							<input
    							 type="text"
    							 id="discount-annual-fee-id-<?php echo $row->id ?>"
    							 placeholder="Discount"
    						  />
						...
						<!--    <input-->
						<!--		type="checkbox"-->
						<!--		name="sibling-discount[<?php echo $row->id ?>]"-->
						<!--		class="id-<?php echo $row->id?> sibling-discount sibling-discount-checkbox-student-id-<?php echo $row->id?>"-->
						<!--		value="<?php echo $row->sibling_discount ?>" checked-->
						<!--	/>-->
						<!--	<input -->
						<!--	     type="text"-->
						<!--	     value="<?php echo $row->sibling_discount ?>"-->
						<!--	     class="sibling-discount-textbox-id-<?php echo $row->id ?>"/>-->
	
						<!--   </td>-->
						<td>
						    <input
								type="checkbox"
								name="tuition-fee[<?php echo $row->id ?>]"
								class="id-<?php echo $row->id?> tuition-fee tuition-fee-checkbox-student-id-<?php echo $row->id?>"
						    ...
						    <input 
						        type="text" 
						        value="<?php echo $row->tuition_fee; ?>" 
						        class="tuition-fee-textbox-id-<?php echo $row->id ?>"
						     />
						     <input
    							 type="text"
    							 id="discount-tuition-fee-id-<?php echo $row->id ?>"
    							 placeholder="Discount"
    						  />
						</td>
						<td>
