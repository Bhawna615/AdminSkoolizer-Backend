	...
	<div class="col-md-12 side-btn-bar">
		...
		<div class="col-md-4" align="right">
			<button class="side-btn" type="button"
				onclick="location.href = '<?php echo site_url('metrics/create') ?>'  ">
				<p>
			...
			<?php if (isset($metrics)) { ?>
				<?php foreach ($metrics as $metric) { ?>
					<tr>
						...
						<td>
							<button class="dt-action-btn" title="Change"
								onclick="location.href='<?php echo site_url('metrics/edit/' . $metric->metric_id) ?>'"
								target="_blank">
								<i class="las la-pen btn-icon"></i>
							</button>
							<button class="dt-action-btn" title="Delete" onclick="myFunction(<?php echo $metric->metric_id ?>)">
