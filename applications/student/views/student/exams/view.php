...
<div class="div_cont">
    ...
    <div class="page-content">
        ...
        <div class="schedule-header-container">
            <i class="schedule-header-icon">&#x1F4DA;</i> <!-- Book Icon (Can be changed) -->
            <h2 class="schedule-header">Upcoming Exams</h2>
        </div>

        <!-- Cards -->
        <div class="schedule-list-container">
            <?php if (empty($exams)) { ?>
                <p class="empty-message">No Exams Found 😊</p>
            <?php } ?>
                    ...
                    <div class="schedule-container">
                        ...
                        <div class="schedule-details-container">
                            <p class="student-home-subject-time">
                                <?php echo "Type: " . htmlspecialchars($exam->Examtype); ?>
                            </p>
                            <p class="student-home-subject-time">
                                <?php echo date("d F, Y", strtotime($exam->Date)); ?>
                            </p>
                            <p class="student-home-subject-time">
                                <?php echo "Maximum Marks: " . htmlspecialchars($exam->Maxmarks); ?>
                            </p>
                        </div>
                    </div>
                <?php } ?>
